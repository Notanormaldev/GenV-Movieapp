  ...
  return info ? (
    ...
    { {background:`   linear-gradient(rgba(0,0,0,.2),rgba(0,0,0,.5),rgba(0,0,0,.8)), 
        url( https://image.tmdb.org/t/p/original/${info.detail.backdrop_path}) `,
                ...
                }} className='relative   w-screen h-[170vh] px-[5%]'>
      ...
      <div className='w-full  flex mx-[5%] mt-[2%]'>
         ...
         <div className='ml-[5%] mt-[3%] text-white'>
            ...
            {info.detail.title || info.detail.name || info.detail.original_name || info.detail.original_title}
             ...
             <small className='text-xl text-zinc-100 font-semibold ml-1'>({info.detail.release_date.split("-")[0]})</small>  </h1>
          ...
          <div className='mt-5 mb-5 text-white flex items-center gap-x-5 '>
             ...
             <h1 className='text-xl mt-5 mb-2 font-semibold'>Movie Translated</h1>
      ...
      {/* part 3 Avl on  */}
      <div className='w-[80%] flex flex-col text-white font-semibold mt-1 ml-[5%]'>
      {info.watchproviders && info.watchproviders.flatrate && (
        <div className='flex items-center gap-x-5'>
             <h1>Available on Platforms</h1> 
             {info.watchproviders.flatrate.map((w)=>(
              <img  title={w.provider_name}   className='w-[5vh] h-[5vh] rounded-md object-cover' src={`https://image.tmdb.org/t/p/original/${w.logo_path}`}  />
             ))}
             </div>
      )}
       {info.watchproviders && info.watchproviders.rent && (
        <div className='flex items-center gap-x-5  mt-3  object-cover'>
             ...
             {info.watchproviders.rent.map((w)=>(
              ...
              <img   title={w.provider_name} className='w-[5vh] h-[5vh] rounded-md' src={`https://image.tmdb.org/t/p/original/${w.logo_path}`}  />
             ))}
             </div>
      )}
   ...
   <Horizontalcards data={info.recommendations>0 ? info.recommendations : info.similar} title={'movie'} />
       </div>
